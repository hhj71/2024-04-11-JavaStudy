 ...
 *                     -----
 *                      => 어디까지 저장 기간을 줄 것인가?
 *                             => 지역 변수 : 메소드 종료와 동시에 사라진다
 *                             			=> 리턴형 / 매개변수
 *                             => 전역 변수 : 프로그램 종료시까지 사용
 *                                      => 클래스 안에 있는 모든 메소드가 메모리를 공유할 수 있다.
 *                                                                 -----------
 *                                                                  공유하는 변수가 어떤 것인지 찾아내는 것이 중요하다.  
 * 	 ============================================================================================================
 *   2.명령문 관리
 *    1) 연산자
 *    2) 제어문 
 ...
 *               
 *   클래스의 종류 
 *    - 일반 클래스 / 추상/ 인터페이스/ 내부클렛/ 익명의 클래스 / 지역클래스 / 멤버클래스
 *       
 *      프로그램이 종료하지 않게 (비종료) : 예외 처리
 *   
 *      => 라이브러리 
 * ===============================================================================     
 */
