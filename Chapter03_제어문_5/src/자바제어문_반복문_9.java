/*
 * 학생 3명의 국어,수학,영어 점수 => 총점, 평균, 학점 구하기
 * 
 */
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
         Scanner scan = new Scanner(System.in);
          // 클래스를 메모리에 저장하라는 연산자 => new (새로운 공간을 만든다)
          // 지역변수 => 메모리에서 관리 / {}이 끝나면 자동으로 메모리에서 삭제
          // new => 프로그래머가 관리 => 자동으로 사라지지 않는다 => 계속 메모리에 존재
          // 메모리 누수현상 ==> GC(가비지 컬렉션 => 프로그램 종료 후 회수)
         for(int i=0; i<3; i++)
         {
        	 System.out.print((i+1)+"학생 국어 입력:");
        	 int kor=scan.nextInt();
        	 System.out.print((i+1)+"학생 영어 입력:");
        	 int eng=scan.nextInt();
        	 System.out.print((i+1)+"학생 수학 입력:");
