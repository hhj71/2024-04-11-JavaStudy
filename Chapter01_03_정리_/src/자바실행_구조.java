 ...
 *           => File / RDBMS (오라클)
 *     2. 변수 / 상수 
 *        변수 => 한개의 데이터를 저장하는 메모리 공간의 별칭 => 변경해서 사용가능
 *               데이터형 변수명;
 *        상수 => 한개의 데이터를 저장하는 메모리 공간의 별칭 => 고정해서 사용
 *               final 데이터형 변수명;
 *    => 변수 명칭법 (클래스, 인터페이스, 배열, 메소드명도 동일) 
 ...
 *         int i=100; 
 *         long l=100L; => L는 long형값이다 
 *         char c='문자1개' => 'A' => ''-> 따옴표 사이에 공백 없으면 오류 발생 => ' '
