 ...
 *               | 클래스에 있는 멤버변수를 저장할 수 있는 공간을 만들어준다.
 ...
 *            1. 설게 => class
 *            2. 메모리 저장 => new
 *            3. 활용 => new로 부터 받은 메모리를 이용해서 활용 => 객체
 *            -------------------------------------------------- 객체지향 프로그램
 ...
 *                 
 *                ----b----                                                                              
 *                  0x100     => a.name , b.name / a.age , b.age => 주소가 동일 
 *                --------- 
...
public class 클래스_9 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		  ...
		  // 메모리 주소를 받는 경우 => 메모리에 있는 변수 자체를 제어할 수 있다 => a의 별칭 => 동시에 같은 메모리 변수를 사용
		  A b=a;
		  System.out.println("b="+b);
		  b.name = "이순신";
		  b.age = 25;
