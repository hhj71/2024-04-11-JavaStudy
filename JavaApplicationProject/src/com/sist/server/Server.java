 ...
 * 		   ------------- 이에 따라 각각 제작하기 어려움 => 한번에 제작 여러개가 동시에 수행 => 쓰레드
 * 			
 * 		=> 자바는 기본적으로 2개의 쓰레드가 있다 => 시분할
 * 					main / gc
 * 
 */
public class Server implements Runnable {
	...
	// 통신 담당 
	// 프로그램안에서 여러개의 프로그램을 동시 수행 => 프로세스 => 여러개의 쓰레드가 동시 수행
	// => Server가 가지고 있는 모든 변수/메소드를 사용할 수 있다 
	// => 한개의 컴퓨터에서 Server는 1개만 동작이 가능하게 만들어두었다
	// => Server는 고정 IP를 가지고 있어야 한다
